...
"""
        try:
            ...
            lines.append("- " * 40)
            lines.append(f"ℹ️  Aliases updated in {env_path}. Run 'source {env_path}' to apply.", file=sys.stderr)
        except Exception:
            pass
    ...
    def index_run(self, project_id: str, force: bool = False):
        ...
        print(f"🚀 Indexing {project['name']}...", file=sys.stderr)
        ...
        return f"✅ Indexing complete. {len(items)} items saved."
    ...
    def docs_add(self, project_id: str, content: str, title: Optional[str] = None, type: str = "note"):
        ...
        print(f"✅ Saved doc (ID: {doc_id})", file=sys.stderr)
        return doc_id
